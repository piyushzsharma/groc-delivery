...
export function Onboarding() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center px-6 pb-12 md:pb-24 pt-10 text-center animate-fade-in w-full">
        ...
        <button
          ...
          className="w-full md:max-w-md bg-primary hover:bg-primary-dark transition-colors text-white font-semibold py-4 rounded-2xl text-lg"
        >
          Get Started
        </button>
      </div>
